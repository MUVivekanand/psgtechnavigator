...
function Home() {
  ...
  const fetchRating = async () => {
    try {
      const response = await axios.post("http://localhost:4000/api/rating", {
        canteen: "F-Block Canteen",
      });
    ...
    <div className="bodyhome">
      <nav className="navbarpsg">
        <ul className="nav-items">
          ...
          <li className="nav-item">
            <a href="#" onClick={Events}>
              Events
            </a>
          </li>
          <li className="nav-item">
            <a href="#" onClick={Faculty}>
              Scheduling
            </a>
          </li>
        </ul>
      ...
      <div className="card">
        ...
        <div className="image-container">
          <div className="image-slider">
            <button className="slide-button left" onClick={prevImage}>
              &lt;
            </button>
            <img
            ...
            <button className="image-button" onClick={toggleInfo}>
              Info
            </button>
            <button className="slide-button right" onClick={nextImage}>
              &gt;
            </button>
          </div>
          {showInfo && (
